...
class AboutRegularExpressions < Neo::Koan
  ...
  def test_the_left_most_match_wins
    assert_equal 'a', "abbccc az"[/az*/]  #[/az*/]finds for a match of a and z (az). Once it finds a it looks for a z next to it. but since there isnt a Z nxt to it it only brings up A 
  end
  ...
  def test_character_classes_give_options_for_a_character
    ...
    assert_equal ['cat', 'bat', 'rat'], animals.select { |a| a[/[cbr]at/] }  #it looks for anything that starts with a C,B,R but ends with at. 
  end
